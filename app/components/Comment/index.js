...
const Comment = ({username, rating, profilePic, comment}) =>{
    ...
    <View>
        <View style={styles.profileWrapper}>
            <ProfilePic size={40} uri='https://bilder.berchtesgadener-land.com/workspace/pixxio/tt.php?w=1600&q=80&dataPath=/pixxiodata/systems/bgl&src=/fileArchiv/tb/TbCqc1wa4Y2wVbKDSf__1535620105_5427100.jpg'/>
